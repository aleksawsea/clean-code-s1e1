...
console.log(editInput);
    ...
    listItem.classList.toggle("todo-form__task-row_edit-mode");
};
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.todo-form__button_edit-task");
    var deleteButton=taskListItem.querySelector("button.todo-form__button_delete-task");
